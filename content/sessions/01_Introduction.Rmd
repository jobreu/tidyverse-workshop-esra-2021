...
knitr::include_graphics(normalizePath("./content/img/hex-tidyverse.png"))
```
...
```{r tidy meme, eval = FALSE}
meme_get("DistractedBf") %>% 
  meme_text_distbf("tidyverse", "new R users", "base R")
```

```{r tidy meme print, echo = FALSE, out.width="60%"}
knitr::include_graphics(normalizePath("./content/img/DistractedBf.png"))
```
...
knitr::include_graphics(normalizePath("./content/img/data-science.png"))
```
]
...
knitr::include_graphics(normalizePath("./content/img/tidyverse-1200x484.png"))
```
]
...
knitr::include_graphics(normalizePath("./content/img/tidy_data.png"))
```
...
knitr::include_graphics(normalizePath("./content/img/wide-long.png"))
```
...
## Converting data into tibbles

We can also convert any `data.frame` into a `tibble`:

```{r tibble-convert, eval = FALSE}
gpc <- as.data.frame(gpc)

tibble::as_tibble(gpc)
```
...
```{r pipe meme, echo = FALSE, eval = FALSE}
meme_get("OprahGiveaway") %>% 
  meme_text_bottom("EVERYONE GETS A %>%!!!", size = 36)
```

```{r pipe-meme-include, echo = FALSE}
knitr::include_graphics(normalizePath("./content/img/OprahGiveaway.png"))
```
