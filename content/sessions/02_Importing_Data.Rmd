...
knitr::include_graphics(normalizePath("./content/img/import_data.png"))
```
...
```{r, out.width = "50%", echo = FALSE}
knitr::include_graphics(normalizePath("./content/img/hex_all_in_one.png"))
```
...
knitr::include_graphics(normalizePath("./content/img/same_picture.jpg"))
```
]
...
```{r, out.width = "50%", echo = FALSE}
knitr::include_graphics(normalizePath("./content/img/export_data.png"))
```
